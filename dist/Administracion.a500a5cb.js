...
var _putJs = require("../../services/put.js"); // Ajusta según la estructura del proyecto
...
async function mostrarSolicitudes() {
    ...
    try {
        let solicitudes = await (0, _getJs.getPermisos)(); // Obtener solicitudes desde db.json
...
function mostrarEnTabla(solicitudes) {
    ...
    for (let solicitud of solicitudes){
        ...
        botonAceptar.onclick = async function() {
            try {
                await (0, _putJs.putSolicitud)(solicitud.id, "aceptado");
        ...
        botonRechazar.onclick = async function() {
            try {
                await (0, _putJs.putSolicitud)(solicitud.id, "rechazado");
                await mostrarSolicitudes(); // Recargar solicitudes después de actualizar
            } catch (error) {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "putSolicitud", ()=>putSolicitud);
